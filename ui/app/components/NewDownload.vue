          ...
          <div class="columns is-multiline is-mobile">
            <div class="column is-12">
              <label class="label is-inline is-unselectable" for="url">
                ...
                <span
                  class="has-tooltip"
                  v-tooltip="'Use Shift+Enter to switch to multiline input mode.'"
                >
                  URLs separated by newlines or
                  <span class="is-bold is-lowercase">{{ getSeparatorsName(separator) }}</span>
                </span>
              </label>
            ...
            <div class="column is-6-tablet is-12-mobile">
              ...
              <div class="field has-addons">
                <div
                  class="control"
                  v-tooltip="`Download path relative to: ${config.app.download_path}`"
                >
                  <label class="button is-static">
              ...
              >
                <template #help>
                  <span class="help is-bold is-unselectable">
                    <span class="icon"><i class="fa-solid fa-info" /></span>
                    <span
                      >All output template naming options can be found at
                      <NuxtLink
                        target="_blank"
            ...
            <div class="column is-12">
              <div class="field is-grouped is-justify-self-end is-hidden-mobile">
                ...
                <div
                  class="control"
                  v-if="config.app.console_enabled"
                  v-tooltip="'Run directly in console'"
                >
                  <button
                    type="button"
...
onUpdated(async () => {
  ...
  if (
    config.isLoaded() &&
    form.value?.preset &&
    !config.presets.some((p) => p.name === form.value.preset)
  ) {
    form.value.preset = config.app.default_preset;
  }
});
