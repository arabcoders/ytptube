    ...
    bottlenecks: [
      {
        ...
        details:
          'Average process CPU usage was 92% over the last 30 samples. 4 active downloads were running.',
      },
    ],
  }),
  memory: () => ({
    ...
    bottlenecks: [
      {
        ...
        details: 'Process write rate averaged 86.5 MB/s while CPU averaged 28%.',
      },
      {
        type: 'disk_write',
        level: 'info',
    ...
    bottlenecks: [
      {
        ...
        level: 'critical',
        summary: 'Process CPU usage is high.',
        details: 'Average process CPU usage was 96%. 6 active downloads running.',
      },
      {
        type: 'memory',
        level: 'critical',
      ...
      },
      {
        ...
        level: 'warning',
        summary: 'The app appears to be write I/O bound.',
        details: 'Process write rate averaged 94.7 MB/s while CPU averaged 96%.',
      },
      {
        type: 'network_download',
        level: 'info',
...
const seedSample = (): void => {
  ...
  latest.value = {
    ...
    disk_usage: { '/downloads': { total_gb: 500, used_gb: 320, free_gb: 180, used_percent: 64 } },
    ...
    connections: 5,
    children: [
      { pid: 1, name: 'ffmpeg', status: 'running', cpu_percent: 180, rss_mb: 420, threads: 12 },
      { pid: 2, name: 'yt-dlp', status: 'running', cpu_percent: 45, rss_mb: 230, threads: 8 },
      { pid: 3, name: 'chromium', status: 'sleeping', cpu_percent: 5, rss_mb: 580, threads: 24 },
    ],
    active_jobs: 3,
    queued_jobs: 18,
    is_paused: false,
