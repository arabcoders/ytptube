...
- IDs are integer values generated by the database.
- The `extras.set_preset` value can select an existing preset when the condition matches.
- The `extras.set_cookies` value can override that preset with Netscape-format cookie file contents.
